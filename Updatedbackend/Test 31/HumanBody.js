...
class HumanBody{
    ...
    processTick(){
        ...
        console.log("TotalGlucolysis :" + (this.intestine.glycolysisPerTick + this.intestine.glycolysisPerTick + this.liver.glycolysisPerTick + this.muscles.glycolysisPerTick+ this.blood.glycolysisPerTick));
        console.log("Total GNG :" + (this.kidneys.gngPerTick + this.liver.gngPerTick));
